...
class MongoDatabaseTest {
    ...
    fun shouldCallTheUnderlyingRunCommand() {
        ...
        whenever(wrapped.runCommand(command, primary, OldDocument::class.java)).doReturn(mock())
        whenever(wrapped.runCommand(clientSession.wrapped, command, primary, OldDocument::class.java)).doReturn(mock())
