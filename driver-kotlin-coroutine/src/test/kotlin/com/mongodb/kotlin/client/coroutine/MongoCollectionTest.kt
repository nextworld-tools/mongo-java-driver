...
class MongoCollectionTest {
    ...
    fun shouldCallTheUnderlyingMapReduce() {
        ...
        whenever(wrapped.documentClass).doReturn(OldDocument::class.java)
        whenever(wrapped.mapReduce(mapFunction, reduceFunction, OldDocument::class.java)).doReturn(mock())
        whenever(wrapped.mapReduce(clientSession.wrapped, mapFunction, reduceFunction, OldDocument::class.java))
            .doReturn(mock())
        ...
        mongoCollection.mapReduce(mapFunction, reduceFunction, OldDocument::class.java)
        mongoCollection.mapReduce(clientSession, mapFunction, reduceFunction, OldDocument::class.java)
        ...
        verify(wrapped, times(2)).documentClass
        verify(wrapped, times(2)).mapReduce(mapFunction, reduceFunction, OldDocument::class.java)
        verify(wrapped, times(2)).mapReduce(clientSession.wrapped, mapFunction, reduceFunction, OldDocument::class.java)
